...
import (
	...
	gw2 "github.com/rongfengliang/restyapp/userservice/pb"
...
func run2() error {
	...
	err = gw.RegisterUserServiceAppHandlerFromEndpoint(ctx, mux, *echoEndpoint, opts)
	if err != nil {
		return err
	}
	err = gw2.RegisterUserServiceAppHandlerFromEndpoint(ctx, mux, *echoEndpoint, opts)
	if err != nil {
		return err
	}
