...
/*
Package userserviceapp is a reverse proxy.
...
var (
	pattern_UserServiceApp_Message_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "userapp", "echo"}, ""))
)
